class Projects {
  constructor() {
    this.data = [
      ...
      {title:"Lead tracking and Marketing Web app", timeline:"MarketXpander, Apr 2014 - Jun 2014", desc:"Leadsquared.com, is a marketing and sales automation software, which enables the customers to track their leads for business purposes, helps the users to create landing pages to capture their leads, to create responsive and innovative email campaigns to nurture the leads, identifies the captured leads who are likely to buy, helps to improve the marketing campaigns of the customers.", tech:"Javascript, HTML5, CSS3, Bootstrap Js, Foundation Js, JQuery UI, JQuery, Kube.css, Ajax, Node, NPM, Gulp, Babel, Phonegap, GIT"},
      {title:"Online Auction and e-commerce Web app", timeline:"Pinaka Informatics, Mar 2013 - Apr 2014", desc:"Connecting all Co-operative Societies in rural areas of Karnataka State, India. The main aim of the project is to connect the un structured societies in the state and make them use the advantages of online publicity and marketing of their products.", tech:"HTML5, CSS3, Javascript, jQuery, Kube.css, JSP, Servlets, Ajax, Node, MySQL, Workbench"},
      {title:"Centralized Public Distribution System", timeline:"Pinaka Informatics, Sep 2011 - Dec 2012", desc:"Centralized Public Distribution System (Stock & inventory management). The objective is to develop a complete centralized public distribution system. The system is divided into different user levels and functional levels.", tech:"HTML, CSS, Javascript, jQuery, JSP, Servlets, Ajax, MySQL, Workbench"},
    ];
