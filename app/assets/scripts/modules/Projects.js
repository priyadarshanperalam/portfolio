class Projects {
  constructor() {
    this.data = [
      {title:"E-commerce Web Application (Bicycle shop)", timeline:"Onepixlab, May 2021 - Present", desc:"One place to connect all the bicycle shops (in Japan). Application has multiple users including retail shops, rental shops, wholesale shops, bikers, bike service centers, bike agents etc. It has an e-commerce portal with inventory management for managing the stocks.", tech:"React-Redux (Web application), Flutter (Cross Platform Mobile Application), Node, NPM, Express, Webpack, Docker, PostgresQL, AWS, Adobe XD, GIT, Jira, Confluence, JUnit, Java and Maven and related technologies"},
      ...
      {title:"Root Cause Analysis Web app", timeline:"TCS, Client: Apple, Aug 2018 - Mar 2020", desc:"Apple Inc. in-house application for IS&T to help Global Business Intelligence. It is used to generate consolidated reports of Apple gadgets. Reports accessibility is controlled and managed by the application. Different varieties of filters and combinations are provided for optimizing the relateds data.", tech:"Javascript, React, Flux, HTML5, CSS3, Ag-Grid, JQuery, Less, Sass, Node, NPM, Express, Python, Webpack, Babel, Ajax, Kafka, graphQL, Oracle, Radar, Karma, Jasmin, JUnit, Apple internal portals and other related technologies"},
      {title:"Field Situation Analysis", timeline:"TCS, Client: Apple, May 2018 - Mar 2020", desc:"Centralized performance analysis application used by Apple Inc higher management for monitoring the key performance indicators(KPI) and alarms. It is used for the generation of a variety of charts and maps. Different varieties of filters and combinations are provided for optimizing the related performance data.", tech:"Angular JS, JQuery, HTML5, CSS3, LESS, Adobe Photoshop, Ajax, Node, NPM, Express, Gulp, Bower, GIT , Web-ex, Jenkins, Radar, Karma, Jasmin, JUnit, Apple internal portals and other related technologies"},
      {title:"GBI Portal Enhancement and Revamp", timeline:"TCS, Client: Apple, Jan 2016 - Mar 2017", desc:"GBI Help is an online information portal that provides users with support documentation across multiple GBI business units. The Global Business Intelligence (GBI) team supports various functional groups with processes and technologies for better decision-making. ies to the decision-makers and end users through a broad range of applications and technologies that gather, store, analyze and provide access to information that helps the business make informed decisions.", tech:"JavaScript, HTML5, CSS3, AngularJs, Bootstrap, jQuery, ExtJs, Ajax, GIT, SVN, Sublime, Omnigraffle, Keynote, Jenkins, Radar, NPM, Express, NodeJs"},
      {title:"Cube Builder (Liger Phase 2)", timeline:"TCS, Client: Apple, Feb 2015 - Aug 2015", desc:"Enhancement of the existing Liger Metadata application. Liger Metadata is the Metadata Management System for Apple. It contains various modules involving Cube builder, which manages the metadata cubes, Areas module that manages the business areas, Aggregates that is used for finding the tables as master or base, Dimensions & Measures, Hierarchies etc.", tech:"JavaScript, HTML5, CSS3, Reviz js, React js, Kube.css, LESS, Bootstrap, Ajax, Radar, GIT, Eclipse, Node, NPM"},
      {title:"Liger - Cube Metadata Generator", timeline:"CS, Client: Apple, Jul 2014 - Jan 2015", desc:"Liger Metadata is the Metadata Management System for Apple. It contains various modules involving Cube builder, which manages the metadata cubes, Areas module that manages the business areas, Aggregates that is used for finding the tables as master or base, Dimensions & Measures, Hierarchies etc.", tech:"JavaScript, HTML5, CSS3, Reviz js, React js, Kube.css, LESS, Bootstrap, Ajax, Radar, GIT, Eclipse, Node, NPM"},
